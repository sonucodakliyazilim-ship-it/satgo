...
const fallbackBanners = [
  {
    id: 'fallback-main',
    title: 'Aracını doğru marka, model ve paketle hızlı sat',
...
const listingSectionConfigs = [
  ...
  },
  {
    ...
    subtitle: 'Alıcıların hızlı karar verdiği kategorilerden seçtiklerimiz',
      ...
      <section className="mx-auto max-w-6xl px-3 pt-4 sm:px-4 sm:pt-5">
        <div className="grid gap-3 lg:grid-cols-[minmax(0,1.7fr)_minmax(280px,0.8fr)]">
          <Link
            ...
            className="group relative block min-h-[220px] overflow-hidden rounded-lg bg-brand text-white shadow-sm sm:min-h-[286px]"
          >
            {heroImage && (
              <img
                src={heroImage}
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-gray-950/85 via-brand/85 to-amber-400/60" />
            ...
            <div className="relative flex min-h-[220px] max-w-2xl flex-col justify-center p-5 sm:min-h-[286px] sm:p-8">
              <p className="mb-3 text-xs font-black uppercase tracking-[0.18em] text-white/80">Satgo Vitrin</p>
              ...
              <span className="mt-6 inline-flex h-11 w-44 items-center justify-center rounded-full bg-white text-sm font-black text-brand-dark">
                İlanları Keşfet
              </span>
            </div>
          </Link>
                ...
                >
                  ...
                  <div className="relative flex min-h-[132px] flex-col justify-center p-4">
                    <p className="text-[11px] font-black uppercase tracking-[0.16em] text-white/70">
                      {index === 0 ? 'Kategori vitrini' : 'Hızlı satış'}
                    </p>
      ...
      <section className="mx-auto max-w-4xl px-3 pt-3 sm:px-4">
        ...
        >
          <div className="min-w-0">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-brand">Satgo satıcı paneli</p>
            <h2 className="truncate text-lg font-black sm:text-2xl">İlanını dakikalar içinde yayına hazırla</h2>
            <p className="hidden text-sm font-semibold text-white/70 sm:block">Kategori hiyerarşisi, detay soruları ve fotoğraf yükleme tek akışta.</p>
          </div>

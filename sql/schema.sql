...
INSERT INTO promotion_packages (name, type, description, price, duration_days, sort_order) VALUES
  ('Öne Çıkan İlan', 'featured',  'Listeleme sayfasında üstte görün, 3x daha fazla tıklanma', 49.00, 7,  1),
  ('Acil İlan',       'urgent',   'Kırmızı "Acil" rozeti ile dikkat çekin',                   29.00, 7,  2),
  ('Vitrin İlanı',    'showcase', 'Ana sayfada vitrin alanında gösterilir',                   79.00, 7,  3),
  ('Üste Taşı',       'boost',    'İlanınızı liste başına tek seferlik taşıyın',              15.00, 1,  4);
